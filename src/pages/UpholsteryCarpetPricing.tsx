  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollectives.com/upholstery-carpet-cleaning-pricing"
        pageType="service"
        county="South Florida"
        breadcrumbs={[
          { name: "Home", url: "https://www.cleancollectives.com" },
          { name: "Upholstery & Carpet Cleaning Prices", url: "https://www.cleancollectives.com/upholstery-carpet-cleaning-pricing" },
        ]}
        faqItems={faqs}
      />
