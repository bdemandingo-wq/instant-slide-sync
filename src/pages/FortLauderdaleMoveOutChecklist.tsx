  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/fort-lauderdale-move-out-checklist"
        pageType="service"
        county="South Florida"
        faqItems={faqItems}
        breadcrumbs={[
          { name: "Home", url: "https://cleancollectives.com" },
          { name: "Fort Lauderdale Move-Out Checklist", url: "https://cleancollectives.com/fort-lauderdale-move-out-checklist" },
        ]}
      />
