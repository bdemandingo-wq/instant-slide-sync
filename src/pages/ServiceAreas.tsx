...
const ServiceAreas = () => {
  ...
  const itemListSchema = {
    ...
    "itemListElement": allCities.map((city, i) => ({
      ...
      "url": `https://cleancollectives.com${city.link}`
    }))
  };
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/service-areas"
        pageType="service"
        breadcrumbs={[
          { name: "Home", url: "https://cleancollectives.com" },
          { name: "Service Areas", url: "https://cleancollectives.com/service-areas" }
        ]}
      />
