  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-pompano-beach"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Pompano Beach", url: "https://www.cleancollective.net/blog/house-cleaning-pompano-beach" }
        ]}
      />
