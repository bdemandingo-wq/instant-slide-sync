  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-coral-gables"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Coral Gables", url: "https://www.cleancollective.net/blog/house-cleaning-coral-gables" }
        ]}
      />
