...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Pembroke Pines communities including Chapel Trail, Silver Lakes, Pembroke Falls, and Pasadena. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-pembroke-pines"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Pembroke Pines", url: "https://cleancollectives.com/blog/house-cleaning-pembroke-pines" }
        ]}
      />
