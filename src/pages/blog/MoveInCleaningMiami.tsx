  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/move-in-cleaning-miami"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "Move-In Cleaning Miami", url: "https://www.cleancollective.net/blog/move-in-cleaning-miami" }
        ]}
      />
