  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-tamarac"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Tamarac", url: "https://www.cleancollective.net/blog/house-cleaning-tamarac" }
        ]}
      />
