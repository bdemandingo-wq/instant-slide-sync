  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-jupiter"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Jupiter", url: "https://www.cleancollective.net/blog/house-cleaning-jupiter" }
        ]}
      />
