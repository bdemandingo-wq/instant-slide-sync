...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Miramar communities including Silver Lakes, Monarch Lakes, Chapel Trail, Royal Palm Ranches, and Riviera Isles. We are licensed, insured, and background-check every cleaner."
  },
  {
