  ...
  return (
    <>
      <SEOSchema
        ...
        pageDescription="Deep cleaning in Miami, FL from $208. Licensed & insured. Brickell, Coral Gables, Coconut Grove & all Miami neighborhoods. Instant quote."
        canonicalUrl="https://cleancollectives.com/blog/deep-cleaning-service-miami"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "Deep Cleaning Miami", url: "https://cleancollectives.com/blog/deep-cleaning-service-miami" }
        ]}
      />
        ...
        <article className="pt-24 pb-16">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="mt-12 p-6 bg-primary text-primary-foreground rounded-xl text-center">
              ...
              <p className="text-primary-foreground/90 mb-5">From $208. Instant quote. Eco-friendly products. Satisfaction guaranteed.</p>
