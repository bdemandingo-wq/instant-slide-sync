...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Royal Palm Beach communities including The Acreage, Crestwood, Versailles, and Royal Palm Beach Commons area. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-royal-palm-beach"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Royal Palm Beach", url: "https://cleancollectives.com/blog/house-cleaning-royal-palm-beach" }
        ]}
      />
