  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-delray-beach"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Delray Beach", url: "https://www.cleancollective.net/blog/house-cleaning-delray-beach" }
        ]}
      />
