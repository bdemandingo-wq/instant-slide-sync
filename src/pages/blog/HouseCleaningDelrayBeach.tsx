...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Delray Beach communities including Mizner Country Club, Polo Club, Lake Ida, and downtown Delray. We are licensed, insured, and background-check every cleaner."
  },
  {
