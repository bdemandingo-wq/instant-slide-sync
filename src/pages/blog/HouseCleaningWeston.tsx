  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-weston"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Weston", url: "https://www.cleancollective.net/blog/house-cleaning-weston" }
        ]}
      />
