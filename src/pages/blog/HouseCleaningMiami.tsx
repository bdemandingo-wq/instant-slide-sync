  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-miami"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Miami", url: "https://www.cleancollective.net/blog/house-cleaning-miami" }
        ]}
      />
