...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Coconut Creek communities including Wynmoor Village, Winston Park, Banyan Trails, and Wiles Road corridor. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-coconut-creek"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Coconut Creek", url: "https://cleancollectives.com/blog/house-cleaning-coconut-creek" }
        ]}
      />
