...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Hallandale Beach communities including Golden Isles, Village at Gulfstream Park, Hallandale Beach oceanfront, and Avant-Garde. Licensed, insured, and background-checked."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-hallandale-beach"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Hallandale Beach", url: "https://cleancollectives.com/blog/house-cleaning-hallandale-beach" }
        ]}
      />
