...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Parkland communities including Heron Bay, Woodlands, Watercrest, Miralago at Watercrest, and Cascades. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-parkland"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Parkland", url: "https://cleancollectives.com/blog/house-cleaning-parkland" }
        ]}
      />
