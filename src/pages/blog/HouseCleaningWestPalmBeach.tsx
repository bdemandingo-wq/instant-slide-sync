  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-west-palm-beach"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning West Palm Beach", url: "https://cleancollectives.com/blog/house-cleaning-west-palm-beach" }
        ]}
      />
