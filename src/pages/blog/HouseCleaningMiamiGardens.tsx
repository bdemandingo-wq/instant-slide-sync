...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Miami Gardens neighborhoods including Norland, Scott Lake, Lake Lucerne, Rolling Oaks, and the Hard Rock Stadium area. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-miami-gardens"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Miami Gardens", url: "https://cleancollectives.com/blog/house-cleaning-miami-gardens" }
        ]}
      />
