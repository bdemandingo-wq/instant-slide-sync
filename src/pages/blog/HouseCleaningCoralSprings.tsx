  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-coral-springs"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Coral Springs", url: "https://cleancollectives.com/blog/house-cleaning-coral-springs" }
        ]}
      />
