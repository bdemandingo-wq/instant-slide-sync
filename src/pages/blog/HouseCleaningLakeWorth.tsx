...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Lake Worth neighborhoods including Lake Worth Beach, Tropical Ridge, College Park, Pinewood, and downtown Lake Worth. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-lake-worth"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Lake Worth", url: "https://cleancollectives.com/blog/house-cleaning-lake-worth" }
        ]}
      />
