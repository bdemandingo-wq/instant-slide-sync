...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Davie communities including Pine Island Ridge, Long Lake Ranches, Laurel Oaks, Imagination Farms, and the downtown Davie area. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-davie"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Davie", url: "https://cleancollectives.com/blog/house-cleaning-davie" }
        ]}
      />
