  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-aventura"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Aventura", url: "https://cleancollectives.com/blog/house-cleaning-aventura" }
        ]}
      />
