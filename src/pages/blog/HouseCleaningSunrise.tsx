  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollectives.com/blog/house-cleaning-sunrise"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Sunrise", url: "https://www.cleancollectives.com/blog/house-cleaning-sunrise" }
        ]}
      />
