...
const faqItems = [
  ...
  },
  {
    ...
    a: "Clean Collective serves all Sunrise communities including Sunrise Lakes, Welleby, Sawgrass Lakes, Springtree, and Inverrary. We are licensed, insured, and background-check every cleaner."
  },
  {
  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/blog/house-cleaning-sunrise"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Sunrise", url: "https://cleancollectives.com/blog/house-cleaning-sunrise" }
        ]}
      />
