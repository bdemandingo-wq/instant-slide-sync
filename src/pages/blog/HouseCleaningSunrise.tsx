  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-sunrise"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning Sunrise", url: "https://www.cleancollective.net/blog/house-cleaning-sunrise" }
        ]}
      />
