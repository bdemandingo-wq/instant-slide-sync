  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://www.cleancollective.net/blog/house-cleaning-north-miami"
        pageType="blog"
        ...
        breadcrumbs={[
          ...
          { name: "House Cleaning North Miami", url: "https://www.cleancollective.net/blog/house-cleaning-north-miami" }
        ]}
      />
