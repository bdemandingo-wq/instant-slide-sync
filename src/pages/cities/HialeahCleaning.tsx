      ...
      <main className="min-h-screen">
        ...
        <section className="py-10 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <Link to="/blog/house-cleaning-hialeah" className="text-primary font-semibold hover:underline">
              Read our Hialeah cleaning guide — pricing, neighborhoods, what's included →
            </Link>
          </div>
        </section>
