  ...
  return (
    <>
      <SEOSchema
        ...
        canonicalUrl="https://cleancollectives.com/deep-cleaning-vs-standard-cleaning"
        pageType="service"
        county="South Florida"
        faqItems={faqItems}
        breadcrumbs={[
          { name: "Home", url: "https://cleancollectives.com" },
          { name: "Deep Cleaning vs Standard Cleaning", url: "https://cleancollectives.com/deep-cleaning-vs-standard-cleaning" },
        ]}
      />
